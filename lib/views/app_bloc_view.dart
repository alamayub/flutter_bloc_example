...
import 'package:flutter_bloc_test/bloc/app.state.dart';
import 'package:flutter_bloc_test/bloc/app_bloc.dart';
import 'package:flutter_bloc_test/bloc/bloc_events.dart';
import 'package:flutter_bloc_test/extentions/stream/start_with.dart';
      ...
      child: BlocBuilder<T, AppState>(
        builder: (context, appState) {
          if (appState.error != null) {
            return const Text('An error has been occurred. Please try again!');
